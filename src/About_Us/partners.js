    ...
    <div className="container mx-auto p-8">
      ...
      <section className="mt-12">
        ...
        <p className="text-gray-500 text-center mb-8">
          We Are Thankful to Our Patrons for Helping Us Provide Free Healthcare
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-8">
          <div className="flex flex-col items-center border border-gray-300 rounded-lg p-4">
            ...
            <p className="text-gray-500 mb-2">
              HUDA is proud to announce that it has been a recipient of the
              Strengthening the Safety Net Grant by Blue Cross Blue Shield for
              six years! This grant recognizes and supports HUDA's dedication to
              providing vital healthcare services to the community.
            </p>
          ...
          <div className="flex flex-col items-center border border-gray-300 rounded-lg p-4">
            ...
            <a
              href="https://humanmedicine.msu.edu/"
              className="text-blue-500 underline hover:text-blue-700 mb-2"
              target="_blank"
              rel="noopener noreferrer"
            >
            ...
            <a
              href="https://chmfamilymedicine.msu.edu/residency-networks/providence-residency/"
              className="text-blue-500 underline hover:text-blue-700 mb-2"
              target="_blank"
              rel="noopener noreferrer"
            >
            ...
            <p className="text-gray-500 mb-2">
              ...
              as well as the Ascension Providence Family Medicine Residency
              Program. Together, physicians & students from these organizations
              strive to increase access to healthcare.
            </p>
            <hr className="w-full border-blue-500 my-4 border-4" />
          </div>
          ...
          <div className="flex flex-col items-center border border-gray-300 rounded-lg p-4">
            ...
            <a
              href="https://osteopathicmedicine.msu.edu/"
              className="text-blue-500 underline hover:text-blue-700 mb-2"
              target="_blank"
              rel="noopener noreferrer"
            >
            ...
            <p className="text-gray-500 mb-2">
              HUDA has partnered with Michigan State University College of
              Osteopathic Medicine for years, providing patients with
              osteopathic manipulative medicine. MSUCOM medical students
              contribute significantly through clinical volunteering and more.
            </p>
            <hr className="w-full border-blue-500 my-4 border-4" />
          </div>
          ...
          <div className="flex flex-col items-center border border-gray-300 rounded-lg p-4">
            ...
            <p className="text-gray-500 mb-2">
              Proud clinical partner of Michigan State University's College of
              Nursing MSN & DNP programs.
            </p>
            <hr className="w-full border-blue-500 my-4 border-4" />
          </div>
          ...
          <div className="flex flex-col items-center border border-gray-300 rounded-lg p-4">
            ...
            <p className="text-gray-500 mb-2">
              HUDA is a recipient of the Community Foundation for Southeast
              Michigan Grant, aimed to expand the operations of our dental
              services and provide access to healthcare through transportation
              services for HUDA patients.
            </p>
            <hr className="w-full border-blue-500 my-4 border-4" />
          </div>
          ...
          <div className="flex flex-col items-center border border-gray-300 rounded-lg p-4">
            ...
            <a
              href="https://www.deltadentalmi.com/"
              className="text-blue-500 underline hover:text-blue-700 mb-2"
              target="_blank"
              rel="noopener noreferrer"
            >
            ...
            <p className="text-gray-500 mb-2">
              HUDA is a recipient of the Brighter Futures Community Grant from
              Delta Dental, three years in a row!
            </p>
            <hr className="w-full border-blue-500 my-4 border-4" />
          </div>
          ...
          <div className="flex flex-col items-center border border-gray-300 rounded-lg p-4">
            ...
            <a
              href="https://applebaum.wayne.edu/"
              className="text-blue-500 underline hover:text-blue-700 mb-2"
              target="_blank"
              rel="noopener noreferrer"
            >
            ...
            <p className="text-gray-500 mb-2">
              HUDA is proud to host Wayne State University's Pharmacy Students
              for their community clinical rotations!
            </p>
            <hr className="w-full border-blue-500 my-4 border-4" />
          </div>
          ...
          <div className="flex flex-col items-center border border-gray-300 rounded-lg p-4">
            ...
            <a
              href="https://www.elitesmilecenter.com/"
              className="text-blue-500 underline hover:text-blue-700 mb-2"
              target="_blank"
              rel="noopener noreferrer"
            >
            ...
            <p className="text-gray-500 mb-2">
              Thank you to Dr. Shakeel Niazi and the folks at the Elite Smile
              Center for helping start our free dental clinic!
            </p>
            <hr className="w-full border-blue-500 my-4 border-4" />
          </div>
          ...
          <div className="flex flex-col items-center border border-gray-300 rounded-lg p-4">
            ...
            <a
              href="https://familyrehabcare.com/"
              className="text-blue-500 underline hover:text-blue-700 mb-2"
              target="_blank"
              rel="noopener noreferrer"
            >
            ...
            <p className="text-gray-500 mb-2">
              Thank you for volunteering your services by providing our patients
              with modalities for pain management, therapeutic exercises to
              restore movement/strength, neuromusuclar reeducation, manual
              therapy, and help them develop home exercise programs!
            </p>
            <hr className="w-full border-blue-500 my-4 border-4" />
          </div>
          ...
          <div className="flex flex-col items-center border border-gray-300 rounded-lg p-4">
            ...
            <a
              href="https://saydetroit.org/clinic/"
              className="text-blue-500 underline hover:text-blue-700 mb-2"
              target="_blank"
              rel="noopener noreferrer"
            >
            ...
            <p className="text-gray-500 mb-2">
              Thank you for helping our female patients with much needed
              specialty services for free!
            </p>
            <hr className="w-full border-blue-500 my-4 border-4" />
          </div>
          ...
          <div className="flex flex-col items-center border border-gray-300 rounded-lg p-4">
            ...
            <a
              href="https://www.circlesocks.com/mens/shaggy-blink-huda"
              className="text-blue-500 underline hover:text-blue-700 mb-2"
              target="_blank"
              rel="noopener noreferrer"
            >
            ...
            <p className="text-gray-500 mb-2">
              For every pair of these socks sold, one pair of socks will be
              donated directly to the homeless population in the Detroit area
              through the HUDA Clinic.
            </p>
            <hr className="w-full border-blue-500 my-4 border-4" />
          </div>
          ...
          <div className="flex flex-col items-center border border-gray-300 rounded-lg p-4">
            ...
            <p className="text-gray-500 mb-2">
              Generous community donor! IAGD sponsor's HUDA Clinic's Pharmacy
              expenses.
            </p>
            <hr className="w-full border-blue-500 my-4 border-4" />
          </div>
          ...
          <div className="flex flex-col items-center border border-gray-300 rounded-lg p-4">
            ...
            <a
              href="https://www.mimuslimcouncil.org/"
              className="text-blue-500 underline hover:text-blue-700 mb-2"
              target="_blank"
              rel="noopener noreferrer"
            >
          ...
          <div className="flex flex-col items-center border border-gray-300 rounded-lg p-4">
            ...
            <a
              href="https://www.tawheedcenter.org/"
              className="text-blue-500 underline hover:text-blue-700 mb-2"
              target="_blank"
              rel="noopener noreferrer"
            >
          ...
          <div className="flex flex-col items-center border border-gray-300 rounded-lg p-4">
            ...
            <a
              href="https://www.themuslimcenter.com"
              className="text-blue-500 underline hover:text-blue-700 mb-2"
              target="_blank"
              rel="noopener noreferrer"
            >
          ...
          <div className="flex flex-col items-center border border-gray-300 rounded-lg p-4">
            ...
            <p className="text-gray-500 mb-2">
              HUDA Clinic is a proud partner of University of Michigan College
              of Pharmacy and School of Dentistry.
            </p>
            <hr className="w-full border-blue-500 my-4 border-4" />
          </div>
          ...
          <div className="flex flex-col items-center border border-gray-300 rounded-lg p-4">
            ...
            <p className="text-gray-500 mb-2">
              HUDA Clinic would like to thank the Breast Cervical Cancer Control
              Program for providing preventative and diagnostic care for our
              female patients.
            </p>
            <hr className="w-full border-blue-500 my-4 border-4" />
          </div>
          ...
          <div className="flex flex-col items-center border border-gray-300 rounded-lg p-4">
            ...
            <a
              href="https://www.eyesurgeonsassoc.com/"
              className="text-blue-500 underline hover:text-blue-700 mb-2"
              target="_blank"
              rel="noopener noreferrer"
            >
              eyesurgeonsassoc.com
            </a>
            <p className="text-gray-500 mb-2">
              HUDA Clinic would like to acknowledge and thank Eye Surgeons and
              Associates for being our ophthalmology partner since our start and
              providing much needed specialty eye care for our patients!
            </p>
            <hr className="w-full border-blue-500 my-4 border-4" />
          </div>
          ...
          <div className="flex flex-col items-center border border-gray-300 rounded-lg p-4">
            ...
            <p className="text-gray-500 mb-2">
              A big thanks to Practice Manager Saroja for always working to see
              HUDA referrals and of course to Dr. Asadullah Mohammed for
              consulting, and treating HUDA patients at his practice pro Bono
            </p>
            <hr className="w-full border-blue-500 my-4 border-4" />
          </div>
          ...
          <div className="flex flex-col items-center border border-gray-300 rounded-lg p-4">
            ...
            <a
              href="https://www.ferndalefamilypharmacy.com/"
              className="text-blue-500 underline hover:text-blue-700 mb-2"
              target="_blank"
              rel="noopener noreferrer"
            >
              ferndalefamilypharmacy.com
            </a>
            <p className="text-gray-500 mb-2">
              Thanks to Ferndale Family Pharmacy for being HUDA Clinic's
              pharmacy partner and for supporting HUDA's mission!
            </p>
            <hr className="w-full border-blue-500 my-4 border-4" />
          </div>
          ...
          <div className="flex flex-col items-center border border-gray-300 rounded-lg p-4">
            ...
            <p className="text-gray-500 mb-2">
              Thanks to Shores Diagnostics for providing ultrasounds for HUDA
              patients and supporting HUDA’s mission.
            </p>
            <hr className="w-full border-blue-500 my-4 border-4" />
          </div>
          ...
          <div className="flex flex-col items-center border border-gray-300 rounded-lg p-4">
            ...
            />
            <h3 className="text-lg font-bold mb-2">
              Premiere Cardiovascular Specialists, Michigan
            </h3>
            <a
              href="https://sites.google.com/pcs-michigan.com/ver3/home"
              className="text-blue-500 underline hover:text-blue-700 mb-2"
              target="_blank"
              rel="noopener noreferrer"
            >
            ...
            <p className="text-gray-500 mb-2">
              Thanks to Premier Cardiovascular Specialists for seeing HUDA
              referrals and supporting HUDA's mission.
            </p>
            <hr className="w-full border-blue-500 my-4 border-4" />
          </div>
          ...
          <div className="flex flex-col items-center border border-gray-300 rounded-lg p-4">
            ...
            <a
              href="https://www.chamberlain.edu/academics/nursing-school/master-of-science-in-nursing"
              className="text-blue-500 underline hover:text-blue-700 mb-2"
              target="_blank"
              rel="noopener noreferrer"
            >
          ...
          <div className="flex flex-col items-center border border-gray-300 rounded-lg p-4">
            ...
            <a
              href="https://authorityhealth.org/programs-resources/michigan-medicaid/"
              className="text-blue-500 underline hover:text-blue-700 mb-2"
              target="_blank"
              rel="noopener noreferrer"
            >
            ...
            <p className="text-gray-500 mb-2">
              A big thank you to Cheryl Porter-Hawkins and Authority Health for
              providing Medicaid enrollment assistance for HUDA Clinic Patients!
            </p>
            <hr className="w-full border-blue-500 my-4 border-4" />
          </div>
          ...
          <div className="flex flex-col items-center border border-gray-300 rounded-lg p-4">
            ...
            />
            <h3 className="text-lg font-bold mb-2">
              Matrix Health and Human Services
            </h3>
            <a
              href="https://www.matrixhumanservices.org/"
              className="text-blue-500 underline hover:text-blue-700 mb-2"
              target="_blank"
              rel="noopener noreferrer"
            >
          ...
          <div className="flex flex-col items-center border border-gray-300 rounded-lg p-4">
            ...
            <a
              href="https://www.accesscommunity.org/"
              className="text-blue-500 underline hover:text-blue-700 mb-2"
              target="_blank"
              rel="noopener noreferrer"
            >
            ...
            <p className="text-gray-500 mb-2">
              Thanks to ACCESS for funding HUDA's in house Medicaid enrollment
              assistance program and allowing us to provide MiBridges access to
          ...
          <div className="flex flex-col items-center border border-gray-300 rounded-lg p-4">
            ...
            <a
              href="https://lahc.org/healthy-living/"
              className="text-blue-500 underline hover:text-blue-700 mb-2"
              target="_blank"
              rel="noopener noreferrer"
            >
            ...
            <p className="text-gray-500 mb-2">
              Thanks to LAHC for providing nutritional classes and exercise
              classes for our patient population such as to increase the
              education in an out-of-clinic setting.
            </p>
            <hr className="w-full border-blue-500 my-4 border-4" />
          </div>
        </div>
      ...
      <section className="mt-12">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-2 gap-8">
            ...
            <div className="bg-white rounded-lg shadow-md p-8 transition-all duration-300 hover:scale-105 hover:bg-blue-100 cursor-pointer h-full flex flex-col justify-between">
              <div>
                ...
                <p className="text-lg text-gray-700">
                  Learn about our journey and how we became a leading healthcare
                  provider in the Metro Detroit area.
                </p>
              </div>
          ...
          <Link to="/ourmission" className="block h-full">
            <div className="bg-white rounded-lg shadow-md p-8 transition-all duration-300 hover:scale-105 hover:bg-blue-100 cursor-pointer h-full flex flex-col justify-between">
              <div>
                <div className="flex items-center mb-4">
                  <svg
