    ...
    <div className="container mx-auto p-8">
      ...
      <section className="mb-12">
        ...
        <div className="flex flex-col items-center">
          ...
          HUDA Clinic first opened its doors in May 2004 to serve the uninsured population of
          the Detroit area. The clinic initially operated on funds gathered by the Muslim community
          of Metro Detroit.
          </p>
        </div>
        <div className="flex flex-col items-center">
...
The HUDA Clinic initially offered only medical services at its original location within the Muslim Center 
of Detroit. After relocating to a larger facility on Woodrow Wilson Street, we expanded our offerings to include 
comprehensive dental, vision, podiatry, and mental health services, along with various specialty services, all 
provided at no cost to our patients. This expansion of services and extended operating hours was made possible 
through the generous support of our donors and volunteers.
      ...
      <div className="flex flex-col md:flex-row mb-12">
        <section className="md:w-1/2 md:mr-4 mb-4 md:mb-0 flex flex-col items-center">
          ...
          />
          <p className="text-lg text-gray-700 text-center">
            At Huda Clinic, we pride ourselves on our staff, equipped with caliber medical
        ...
        <section className="md:w-1/2 flex flex-col items-center">
          ...
          <img src={chairmanImg} alt="Our Values" className="w-[70%] mb-4 border-2 border-gray-300 rounded-xl" />
          <p className="text-lg text-gray-700 text-center">
      ...
      <section className="mb-12">
        ...
        <div className="flex justify-center mb-8">
          <img src={nafc2021} alt="Logo" className="w-48 h-48 mx-4 border-2 border-gray-300 rounded-xl" />
          <img src={nafc2022} alt="Logo" className="w-48 h-48 mx-4 border-2 border-gray-300 rounded-xl" />
          <img src={nafc2023} alt="Logo" className="w-48 h-48 mx-4 border-2 border-gray-300 rounded-xl" />
          <img src={nafc2024} alt="Logo" className="w-48 h-48 mx-4 border-2 border-gray-300 rounded-xl" />
          <img src={nafcLogo} alt="Logo" className="w-48 h-48 mx-4 border-2 border-gray-300 rounded-xl" />
          <img src={fcom} alt="Logo" className="w-48 h-48 mx-4 border-2 border-gray-300 rounded-xl" />
        </div>
      </section>
      <section>
