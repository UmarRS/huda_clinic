      ...
      <section className="container mx-auto py-8">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          <div className="space-y-4">
            ...
            <p>
              Explore our wide range of healthcare services designed to meet the
            ...
            <p>
              Our comprehensive healthcare services are designed to cater to all
              your medical needs. Explore our offerings and discover how we can
      ...
      <section className=" py-8">
        <div className="container mx-auto">
          ...
          <div className="bg-white p-6 rounded-md border">
            <p>
              New patients are always welcome at the HUDA Clinic! You can
              schedule your initial appointment by visiting our clinic during
              our regular hours, or you may also come for a walk-in appointment
              before 10:30 AM, or until we reach our capacity on the days we
              offer walk-ins (see below).
            </p>
            <p>
              New patients must bring with them a valid photo ID, and must be at
              least 18 years old.
            </p>
            <h4 className="text-xl font-bold text-black mt-4">Hours:</h4>
